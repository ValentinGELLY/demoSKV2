...
export class EnScanDocumentoComponent extends GenericComponent {
  ...
  override onImageDocumentCapture = (e: any) => {
    switch (e.data.dataType) {
      case 'ImageCaptured':
        ...
        if (this.router.url === "/EN/scanDocumento" && this.telefonicaService.scanVisited === 1) {
          setTimeout(() => {
            this.telefonicaService.previewImageProfile = this.skService.lastCaptureImageRaw();
          }, 500);
        } else if (this.telefonicaService.scanVisited === 2 && this.router.url === "/EN/cameraIdentification") {
          setTimeout(() => {
        ...
        } else if (this.telefonicaService.scanVisited === 3 && this.router.url === "/EN/cameraIdentification") {
          setTimeout(() => {
  ...
  previewImageUpdate = (preview: any): void => {
    if (this.telefonicaService.scanVisited === 2 && this.router.url === "/EN/scanDocumento") {
    ...
    } else if (this.telefonicaService.scanVisited === 3 && this.router.url === "/EN/scanDocumento") {
