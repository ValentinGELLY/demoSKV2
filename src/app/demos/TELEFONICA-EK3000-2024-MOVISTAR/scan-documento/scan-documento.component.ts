...
export class ScanDocumentoComponent extends GenericComponent {
  ...
  override onImageDocumentCapture = (e: any) => {
    switch (e.data.dataType) {
      case 'ImageCaptured':
        ...
        if (this.router.url === "/scan-documento" && this.telefonicaService.scanVisited === 1) {
          setTimeout(() => {
            this.telefonicaService.previewImageProfile = this.skService.lastCaptureImageRaw();
          }, 500);
        } else if (this.telefonicaService.scanVisited === 2 && this.router.url === "/cameraIdentification") {
          setTimeout(() => {
        ...
        } else if (this.telefonicaService.scanVisited === 3 && this.router.url === "/cameraIdentification") {
          setTimeout(() => {
  ...
  previewImageUpdate = (preview: any): void => {
    if (this.telefonicaService.scanVisited === 2 && this.router.url === "/scan-documento") {
    ...
    } else if (this.telefonicaService.scanVisited === 3 && this.router.url === "/scan-documento") {
