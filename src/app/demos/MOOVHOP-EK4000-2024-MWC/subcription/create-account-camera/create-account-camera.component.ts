...
export class CreateAccountCameraComponent extends GenericComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
     ...
     * Déclenchement de l'appel à DocumentScanning.preview()
      */
    let __this = this;
    if (this.isScanFinished && this.router.url === "/MWC2024/createAccountCamera") {
    ...
    } else if (!this.isScanFinished && this.router.url === "/MWC2024/createAccountCamera") {
