...
@Component({
  ...
  styleUrls: ['./moov-hop-buy-use-case-scan-newer-identity-card.component.scss', '../../moovHop.scss']
})
export class MoovHopBuyUseCaseScanNewerIdentityCardComponent extends GenericComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    switch (e.data.dataType) {
      case 'ImageCaptured':
        ...
        let navEvent = new CustomEvent("moovHopNav", {
          detail: {
            "delay": 2000,
            "goTo": "/moovHopBuyUseCaseNewerCIScanOneProgressing"
          }
        });
