...
export const routes: Routes = [
  {path:'EUMO2024/homepage', component: HomepageComponent},
  {path:'EUMO2024/subScriptionConfirmation', component: PaymentSubscriptionConfirmationComponent},
  {path:'EUMO2024/paymentCB', component: PaymentCardComponent},
  {path:'EUMO2024/createAccountQRCodeYesNo', component:CreateAccountQRCodeYesNoComponent},
  {path:'EUMO2024/createAccountQRCodeScan', component:CreateAccountQRCodeScanComponent},
  {path:'EUMO2024/paymentChoice' , component: PaymentChoiceComponent},
  {path:'EUMO2024/paymentAppMobile',component:PaymentAppMobileComponent },
  {path:'EUMO2024/paymentMobileOp', component:PaymentMobileOpComponent},
  {path:'EUMO2024/paymentMobileOpValidation', component:PaymentMobileOpValidationComponent},
  {path:'EUMO2024/createAccountMenu', component: CreateAccountMenuComponent},
  {path:'EUMO2024/createAccountCamera', component: CreateAccountCameraComponent},
  {path:'EUMO2024/createAccountPersonalInformations', component:CreateAccountPersonalInformationsComponent},
  {path:'EUMO2024/createAccountProofAddress', component:CreateAccountProofAddressComponent},
  {path:'EUMO2024/createAccountSubscriptionChoice', component:CreateAccountSubscriptionChoiceComponent},
  {path:'EUMO2024/createAccountScanFinish', component:CreateAccountScanFinishComponent},
  {path:'EUMO2024/createAccountHello', component:CreateAccountHelloComponent},
  {path:'EUMO2024/printingMenu', component:PrintingMenuComponent},
  {path:'EUMO2024/printingInformationChoice', component:PrintingInformationChoiceComponent},
  {path:'EUMO2024/printingMethodsGettingTimetable', component:PrintingMethodsGettingTimetableComponent},
  {path:'EUMO2024/printingThanks', component:PrintingThanksComponent},
  {path:'EUMO2024/printingScanQRcode', component:PrintingScanQRcodeComponent},
  {path:'EUMO2024/informationSummary', component:InformationSummaryComponent},
  {path:'EUMO2024/identificationMenu', component:IdentificationMenuComponent},
  {path:'EUMO2024/identificationValidation', component:IdentificationValidationComponent},
  {path:'EUMO2024/scanQrCode', component:ScanQrCodeComponent},
  {path:'EUMO2024/waitingScreenPrinting', component:WaitingScreenPrintingComponent},
  {path:'EUMO2024/thanksPaymentReport', component:ThanksPaymentReportComponent},
  {path:'EUMO2024/createAccountFaceCapture', component:CreateAccountFaceCaptureComponent},
  {path:'EUMO2024/createAccountValidationScreen', component:CreateAccountValidationScreen}
];
...
export class MoovHop4000RoutingModuleEUMO2024 { }
