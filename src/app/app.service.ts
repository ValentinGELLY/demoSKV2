...
export class AppService implements OnInit {
  ...
  goOnCatalog(){
    this.pageBeforeSwitch = this.router.url;
    this.router.navigate(["/catalogIPM"]);
  }

  goBackOnPreviousPage(){
    this.router.navigate([this.pageBeforeSwitch]);
  }
